...
<body class="font-sans antialiased">
    ...
    <aside class="fixed left-0 top-0 z-40 h-screen w-52 -translate-x-full transition-transform sm:w-64 sm:translate-x-0"
        ...
        <div class="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
            ...
            <ul class="mt-4 space-y-2 border-t border-gray-200 pt-4 font-medium dark:border-gray-700">
                <li>
                    <a class="group flex items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        href="#">
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 17 20">
    ...
    <div class="bg-[#ecf0f5] p-4 pt-20 sm:ml-64">
