        ...
        <div class="w-full rounded-lg bg-white p-5">
            ...
            <form action="{{ route('product.update', $product) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        id="price" name="standard_price" type="number"
                        value="{{ old('standard_price', $product->standard_price) }}" placeholder="price" required>
                ...
                <div class="mb-5 flex w-full flex-col justify-center">
                    <label class="mb-2 block text-sm font-medium text-gray-900" for="dropzone-file">Upload New Photo</label>
                    <label
                        ...
                        <div class="flex flex-col items-center justify-center pb-6 pt-5">
                            <svg class="mb-4 h-8 w-8 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 AS  ADX XAM  0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                            </svg>
                ...
                <div class="mb-3">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4" id="image-container">
                        <div class="relative" id="image-ori">
                            <img class="border-primary-500 h-56 w-full rounded-md border-2 shadow-sm"
                                src="{{ asset('assets/img/' . $product->image) }}" alt="image-ori">
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        ...
        function deleteImageOri(el) {
            const imageOri = $("#image-ori");
            if (imageOri) imageOri.remove();
        }
